...
<div class="container">
    <table class="table" border = 1 cellpadding = "10" cellspacing="0">
        ...
        <tr>
            <td><?= $i++ ;?></td>
            <td>
              <a href="php/hapus.php?id=<?= $b['id'] ;?>" onclick="return comfirm('apakah anda yakin??;')"><button class="hapus">Hapus</button></a>
              <a href="php/ubah.php?id=<?= $b['id'] ;?>"><button class="ubah">Ubah</button></a>
            </td>
